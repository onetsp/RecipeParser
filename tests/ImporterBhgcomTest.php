...
class ImporterBhgcomTest extends PHPUnit_Framework_TestCase {

    public function test_eggnog_cheesecake() {
        $path_orig = "data/clipped/bhg_com_bhg_39_s_newest_s_eggnog_cheesecake_with_candied_curl.html";
    ...
    public function test_tomatillo_chicken_soup() {
        $path_orig = "data/clipped/bhg_com_bhg_39_s_newest_s_tomatillo_chicken_soup_curl.html";
